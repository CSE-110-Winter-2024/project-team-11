...
public class GoalTest {
    ...
    @Test
    public void getters() {
        var goal = new Goal(4, "shopping", 12, false);
    ...
    public void withId() {
        var goal = new Goal(4, "shopping", 12, false);
        var expected = new Goal(23, "shopping", 12, false);
    ...
    public void withIsCompleted() {
        var goal = new Goal(4, "shopping", 12, false);
        var expected = new Goal(4, "shopping", 12, true);
    ...
    public void withSortOrder() {
        var goal = new Goal(4, "shopping", 12, false);
        var expected = new Goal(4, "shopping", 325, false);
    ...
    public void testEquals() {
        var goal1 = new Goal(4, "shopping", 12, false);
        var goal2 = new Goal(4, "shopping", 12, false);
        var goal3 = new Goal(4, "shopping", 12, true);
